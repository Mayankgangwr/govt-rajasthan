        ...
        <div className='w-full'>
          ...
          <div className='mt-[32px] w-full overflow-auto'>
            ...
            <div className=' flex flex-col lg:flex-row justify-end items-center gap-[10px] mt-[24px] mr-[7rem]'>
              ...
              <div className='grid grid-cols-4 w-[90vw] lg:w-[450px] bg-white rounded-[6px] shadow-lg border border-[#00000040] h-[40px] text-center items-center' style={{marginRight: '2vw'}}>
